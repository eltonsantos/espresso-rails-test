...
Rails.logger.debug 'Criando empresas'
...
Rails.logger.debug 'Criando cartões'
cards_employee1 = [
...
Rails.logger.debug 'Criando despesas'
def create_statements(_user, cards, categories)
  5.times do |i|
    Statement.create!(
      performed_at: Time.zone.now - i.days,
      cost: rand(10..50),
